...
import { getContentMetrics, getContentHostEarnings, getPurchaseReceipt } from '../reducers/account.reducer'
...
const mapStateToProps = (state, props) => ({
    ...
    contentHostEarnings: state.account.contentHostEarnings[props.video.contentHostId] || new BigNumber(0),
})
