    ...
    render() {
        return (
            <div style={{marginLeft: 'auto'}}>
                <IconButton onClick={this._openDialog} style={{width: 32, height: 32}}>
                    ...
                    <DialogContent>
                        <DialogContentText>
                            ...
                            {this.state.exportError && (
                                <p style={{color: 'red'}}>{`Export error: ${this.state.exportError.message}`}</p>
                            )}
                        </DialogContentText>
                    </DialogContent>
                    <DialogActions>
                        ...
                        <Button onClick={this._export} color="primary" disabled={this.state.exporting}>
