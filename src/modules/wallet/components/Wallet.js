...
class Wallet extends PureComponent {
    ...
    render() {
        ...
        const networkTokenBalanceFormatted = formattedTokenAmount(
            networkTokenBalance,
            1,
            true,
            false
        );
        const icoTokenBalanceFormatted = formattedTokenAmount(
            primordialTokenBalance,
            1,
            true,
            true
        );
        const tokenStakedFormatted = formattedTokenAmount(
            tokenStaked,
            1,
            true,
            false
        );
        const tokenEarnedFormatted = formattedTokenAmount(
            tokenEarned,
            1,
            true,
            false
            ...
            <div className="Wallet" style={{ opacity: ethAddress ? 1 : 0.5 }}>
                <div className="balance-container">
                    ...
                    <div className="balances">
                        <div>
                            ...
                            >
                                {networkTokenBalanceFormatted.value}
                            </Typography>
                            <Typography variant="body1">
                                {networkTokenBalanceFormatted.label}
                            </Typography>
                        </div>
                        <div>
                            <Typography
                            ...
                            >
                                {icoTokenBalanceFormatted.value}
                            </Typography>
                            <Typography variant="body1">
                                {icoTokenBalanceFormatted.label}
                            </Typography>
                        </div>
                    </div>
                </div>
                <div className="token-metrics-container">
                    <div>
                        ...
                        <Typography variant="body1">
                            <b>{tokenStakedFormatted.value}</b>{" "}
                            {tokenStakedFormatted.label}
                        </Typography>
                    </div>
                    <div>
                        <Typography variant="caption">
                        ...
                        <Typography variant="body1">
                            <b>{tokenEarnedFormatted.value}</b>{" "}
                            {tokenEarnedFormatted.label}
                        </Typography>
                    </div>
                </div>
                <PrimaryButton
