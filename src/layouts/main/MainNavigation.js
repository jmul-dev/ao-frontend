    ...
    <nav className={classnames('MainNavigation', { offcanvas })}>
        <div className={classes.container}>
            <ul className={classes.navList}>
                <li className={`${classes.navListItem} ${classes.walletListItem}`}>
                    <NavLink className={`${classes.navListItemLink} ${classes.navListItemWallet}`} to="/app/view/wallet" replace={overlayViewsActive}>
